      ...
      <section className="relative overflow-hidden border-b border-border-dark">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10">
              <p className="mb-4 text-sm text-text-muted">Find us on</p>
              <div className="flex flex-wrap justify-center gap-3">
                <a
                  href="https://www.tiktok.com/@flexlessofficial"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-border-dark bg-primary-light/50 text-text-muted transition-all hover:-translate-y-0.5 hover:border-secondary/30 hover:text-text-primary"
                  aria-label="TikTok"
                >
